  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        {/* Icône : couleur neutre (gris), plus de bleu */}
        <div className="shrink-0 w-10 h-10 rounded-xl bg-zinc-100 dark:bg-slate-900 grid place-items-center text-zinc-300">
          {/* on passe l’icône SANS classe qui force le bleu */}
          {icon}
        </div>
...
export default function Home() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Grille des modules — mêmes cards que le bandeau */}
